...
setup(
    name="aegis-openai",
    version="1.1.4",
    description="OpenAI tool_calls governance middleware for Aegis ACP (maintenance-only — Anthropic SDK is the active hero)",
    ...
    project_urls={
        ...
        "Documentation": "https://github.com/Abhi-mishra998/aegis/blob/main/integrations/aegis-openai/README.md",
    ...
    keywords=["ai", "governance", "openai", "gpt", "security", "aegis", "guardrails", "tool-use"],
    classifiers=[
