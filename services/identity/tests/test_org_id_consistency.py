...
@pytest.mark.asyncio
async def test_user_creation_with_mismatched_org_id_rejected(db: AsyncSession) -> None:
    """
...
@pytest.mark.asyncio
async def test_existing_null_org_id_runtime_fallback(db: AsyncSession) -> None:
    """
...
@pytest.mark.asyncio
async def test_token_issuance_includes_correct_org_id(db: AsyncSession) -> None:
    """
...
@pytest.mark.asyncio
async def test_user_model_invariant_enforcement(db: AsyncSession) -> None:
    """
