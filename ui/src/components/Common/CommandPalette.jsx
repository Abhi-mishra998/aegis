...
const COMMANDS = [
  { id: 'flight-recorder', label: 'Flight Recorder',   path: '/flight-recorder',  icon: Activity,   group: 'Navigate' },
  ...
  { id: 'incidents',       label: 'Incidents',         path: '/incidents',        icon: AlertTriangle, group: 'Navigate' },
  { id: 'live-feed',       label: 'Live Event Feed',   path: '/live-feed',        icon: Radio,      group: 'Navigate' },
  { id: 'agents',          label: 'Agents',            path: '/agents',           icon: Users,      group: 'Navigate' },
  { id: 'forensics',       label: 'Forensics',         path: '/forensics',        icon: FileText,   group: 'Navigate' },
  { id: 'identity-graph',  label: 'Identity Graph',    path: '/identity-graph',   icon: Activity,   group: 'Navigate' },
  { id: 'compliance',      label: 'Compliance',        path: '/compliance',       icon: Shield,     group: 'Navigate' },
  ...
  { id: 'siem',            label: 'SIEM Integration',  path: '/siem',             icon: BarChart2,  group: 'Navigate' },
  { id: 'policy-analytics',label: 'Policy Analytics',  path: '/policy-analytics', icon: BarChart2,  group: 'Navigate' },
  { id: 'quota',           label: 'Quota Management',  path: '/quota',            icon: Activity,   group: 'Navigate' },
  { id: 'threat-intel',    label: 'Threat Intelligence',path: '/threat-intel',    icon: Shield,     group: 'Navigate' },
  { id: 'sso',             label: 'SSO Configuration', path: '/sso',              icon: Lock,       group: 'Navigate' },
  { id: 'notifications',   label: 'Notifications',     path: '/notifications',    icon: Activity,   group: 'Navigate' },
  { id: 'settings',        label: 'Settings',          path: '/settings',         icon: Terminal,   group: 'Navigate' },
  { id: 'playground',      label: 'Agent Playground',  path: '/playground',       icon: Terminal,   group: 'Navigate' },
  { id: 'playbooks',       label: 'Playbooks',         path: '/playbooks',        icon: Shield,     group: 'Navigate' },
