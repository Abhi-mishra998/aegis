...
const EVENT_META = {
  ...
  llm_proxy_call:     { label: 'LLM Proxy Call',      color: 'text-cyan-400',   dot: 'bg-cyan-500',   border: 'border-cyan-500/20' },
  llm_proxy_escalate: { label: 'LLM Proxy Escalate',  color: 'text-purple-400', dot: 'bg-purple-500', border: 'border-purple-500/20' },
  // ── added in U5 ──
    ...
    <div className={`group flex items-start gap-3 px-4 py-3 border-b border-[var(--border-subtle)] hover:bg-white/[0.02] transition-colors`}>
      ...
      <div className="shrink-0 text-right flex flex-col items-end gap-1.5">
        ...
        <button
          ...
          aria-label="Review / Investigate this event"
        >
