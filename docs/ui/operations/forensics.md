...
- **Read DSN routes to RDS replica**: heavy forensics queries hit `acp-postgres-prod-replica`. After an RDS failover, give the replica a few minutes to promote before retrying.
