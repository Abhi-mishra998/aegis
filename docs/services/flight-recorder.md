...
```bash
curl -sS https://ha.aegisagent.in/flight/timelines?limit=10 \
...
```bash
TID=$(curl -sS https://ha.aegisagent.in/flight/timelines?limit=1 \
  -H "Authorization: Bearer $TOKEN" \
  -H "X-Tenant-ID: 00000000-0000-0000-0000-000000000001" \
  | jq -r '.data.items[0].id')

curl -sS https://ha.aegisagent.in/flight/timeline/$TID \
  -H "Authorization: Bearer $TOKEN" \
  -H "X-Tenant-ID: 00000000-0000-0000-0000-000000000001" \
